...
<head>
  ...
  <title>HTML5 TweenMax.js和jQuery实现的3D图片动画DEMO演示</title>


    <link rel="stylesheet" href="${request.contextPath}/assets/show/css/style.css" media="screen" type="text/css" />
...
<body>
  ...
  <script src='${request.contextPath}/assets/show/js/libs.min.js'></script>

  <script src="${request.contextPath}/assets/show/js/index.js"></script>
